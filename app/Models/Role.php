...
class Role extends Model
{
    ...
    {
        return $this->belongsToMany(Permission::class, 'permission_role')->withPivot('permission_group_id');
    }
    ...
    {
        return $this->belongsToMany(PermissionGroup::class, 'permission_role')->withPivot('permission_id');
    }
