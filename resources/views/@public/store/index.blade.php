                ...
                <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                            ...
                            <li class="breadcrumb-item text-nowrap active" aria-current="page">Stores</li>
                        </ol>
                    </nav>
                </div>
                <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
                    <h1 class="h3 text-light mb-0"><i style="margin-right: 5px;" class="czi-bag"></i> Stores</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    {{--                            </div>--}}
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="font-size-sm mr-2">
                                    <i class="czi-bag text-muted mr-1"></i>{{ $store->products()->count() }}<span class="font-size-xs ml-1">Products</span>
                                </div>
                            </div>
                        </div>
                    </div>
