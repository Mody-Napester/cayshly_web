            ...
            <section class="col-lg-8">
                ...
                <div class="card card-body">
                    <div class="d-flex justify-content-between align-items-center pt-3 pb-2 pb-sm-5 mt-1">
                        ...
                        <a class="btn btn-outline-primary btn-sm pl-2" href="shop-grid-ls.html"><i class="czi-arrow-left mr-2"></i>Continue shopping</a>
                    </div>
                    ...
                    <div class="text-right">
                        <button class="btn btn-outline-accent" type="button"><i class="czi-loading font-size-base mr-2"></i>{{ trans('cart.Update_cart') }}</button>
                    </div>
                </div>
...
{{--                    </div>--}}
                    ...
                    <a class="btn btn-primary btn-shadow btn-block mt-4" href=""><i class="czi-card font-size-lg mr-2"></i>Proceed to Checkout</a>
                </div>
            </aside>
        </div>
    </div>
