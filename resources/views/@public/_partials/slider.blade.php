                        ...
                        <div>
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-5 col-md-6 offset-lg-1 order-md-1 pt-4 pb-md-4 text-center text-md-left">
                                    <h2 class="font-weight-light pb-1 from-bottom">{{ getFromJson($slider->text_1 , lang()) }}</h2>
                                    <h1 class="display-4 from-bottom delay-1">{{ getFromJson($slider->text_2 , lang()) }}</h1>
                                    <h5 class="font-weight-light pb-3 from-bottom delay-2">{{ getFromJson($slider->text_3 , lang()) }}</h5>
...
{{--                    <div class="d-flex d-xl-block"><a class="media w-100 align-items-center bg-faded-info rounded-lg pt-2 pl-2 mb-4 mr-4 mr-xl-0" href="#" style="min-width: 16rem;"><img src="{{ url('assets_public') }}/img/home/banners/banner-sm01.png" width="125" alt="Banner">--}}
...
{{--                            </div></a><a class="media w-100 align-items-center bg-faded-warning rounded-lg pt-2 pl-2 mb-4 mr-4 mr-xl-0" href="#" style="min-width: 16rem;"><img src="{{ url('assets_public') }}/img/home/banners/banner-sm02.png" width="125" alt="Banner">--}}
{{--                            <div class="media-body py-4 px-2">--}}
...
{{--                            </div></a><a class="media w-100 align-items-center bg-faded-success rounded-lg pt-2 pl-2 mb-4" href="#" style="min-width: 16rem;"><img src="{{ url('assets_public') }}/img/home/banners/banner-sm03.png" width="125" alt="Banner">--}}
{{--                            <div class="media-body py-4 px-2">--}}
