        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <ul class="list-unstyled font-size-sm">
                                <li><span class="text-muted">Client:&nbsp;</span>{{ $client_name }}</li>
                                <li><span class="text-muted">Address:&nbsp;</span>{{ $client_address }}</li>
                                <li><span class="text-muted">Phone:&nbsp;</span>{{ $client_phone }}</li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                            <h4 class="h6">Payment method:</h4>
                            <ul class="list-unstyled font-size-sm">
                                <li><span class="text-muted">Payment method:&nbsp;</span>{{ $client_payment }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <aside class="col-lg-4 pt-4 pt-lg-0">
                <div class="cz-sidebar-static rounded-lg box-shadow-lg ml-lg-auto">
                    ...
                    @if(auth()->check())
                        <a class="btn btn-success btn-shadow btn-block mt-4" href="{{ route('public.cart.complete') }}"><i class="czi-card font-size-lg mr-2"></i>Place Order</a>
                    @endif
