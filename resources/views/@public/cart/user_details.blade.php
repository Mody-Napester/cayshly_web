            ...
            <div class="row">
                <section class="col-lg-8">
                    ...
                    <div class="card card-body my-addresses" style="display: none;">
                        <!-- Shipping address-->
                        <h2 class="h6 pt-1 pb-3 mb-3 border-bottom">My addresses</h2>
                    ...
                    <!-- Shipping address-->
                        ...
                        <form action="{{ route('public.address.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="user_address">Address details</label>
                                <textarea name="user_address" id="user_address" rows="5" class="form-control" placeholder="New address"></textarea>
                            </div>
                        ...
                        <div class="card card-body cart-addresses">
                            ...
                            @if(auth()->check())
                                <div class="mb-3 text-right">
                                    <a class="btn btn-success add-address-view"><i class="czi-map"></i> Add Address</a>
                                </div>
                            ...
                            @else
                                <div class="p-5 text-center">
                                    ...
                                    <a href="{{ route('register') }}" class="btn btn-secondary">Or Register</a>
                                </div>
                        @endif
                                ...
                                @if(auth()->check())
                                    <div class="col-md-6 col-sm-6 col-xs-6 mb-3">
                                        <a class="btn btn-secondary btn-block" href="{{ route('public.cart.details') }}">
                                            ...
                                            <span class="d-sm-inline">Back to Cart</span>
                                        </a>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6 mb-3">
                                        <button type="submit" class="btn btn-primary btn-block">
                                            <span class="d-sm-inline">Proceed to Payment</span>
