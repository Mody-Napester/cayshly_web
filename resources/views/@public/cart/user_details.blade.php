            ...
            <div class="row rtl-ar">
                <section class="col-lg-8">
                    ...
                    <!-- Shipping address-->
                        ...
                        <form class="" action="{{ route('public.address.store') }}" method="post">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-primary fire-loader-button">{{ trans('cart.Save') }}</button>
                        </form>
                            ...
                            <div class="row mt-3">
                                @if(auth()->check())
                                    <div class="col-md-6 col-sm-6 col-xs-6 mb-3">
                                        <a class="btn btn-secondary btn-block fire-loader-anchor" href="{{ route('public.cart.details') }}">
                                            <i class="czi-arrow-left mt-sm-0 mr-1"></i>
                                            <span class="d-sm-inline">{{ trans('cart.Back_to_Cart') }}</span>
                                        </a>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6 mb-3">
                                        <button type="submit" class="btn btn-primary btn-block fire-loader-button">
