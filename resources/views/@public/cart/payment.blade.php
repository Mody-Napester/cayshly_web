            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                        ...
                        <li class="breadcrumb-item text-nowrap active" aria-current="page">{{ trans('cart.Checkout') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
                <h1 class="h3 text-light mb-0">{{ trans('cart.Checkout') }}</h1>
            </div>
        </div>
    </div>
    <!-- Page Content-->
...
{{--                        </div>--}}
                    ...
                    <div class="d-none d-lg-flex pt-4">
                        ...
                        <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="{{ route('public.cart.review') }}"><span class="d-none d-sm-inline">{{ trans('cart.Review_your_order') }}</span><span class="d-inline d-sm-none">{{ trans('cart.Review_order') }}</span><i class="czi-arrow-right mt-sm-0 ml-1"></i></a></div>
                    </div>
                </div>
            </section>
