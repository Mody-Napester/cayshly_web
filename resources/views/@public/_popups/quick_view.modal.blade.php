        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title product-title">
                    <a href="" data-toggle="tooltip" data-placement="right" title="Go to product page">Smartwatch Youth Edition<i class="czi-arrow-right font-size-lg ml-2"></i></a></h4>
                    ...
                    <div class="col-lg-7 pr-lg-0">
                        <div class="cz-product-gallery">
                            <div class="cz-preview order-sm-2">
                                <div class="cz-preview-item active" id="first"><img class="cz-image-zoom" src="{{ url('assets_public') }}/img/shop/single/gallery/05.jpg" data-zoom="img/shop/single/gallery/05.jpg" alt="Product image">
                                    <div class="cz-image-zoom-pane"></div>
                                </div>
                                <div class="cz-preview-item" id="second"><img class="cz-image-zoom" src="{{ url('assets_public') }}/img/shop/single/gallery/06.jpg" data-zoom="img/shop/single/gallery/06.jpg" alt="Product image">
                                    <div class="cz-image-zoom-pane"></div>
                                </div>
                                <div class="cz-preview-item" id="third"><img class="cz-image-zoom" src="{{ url('assets_public') }}/img/shop/single/gallery/07.jpg" data-zoom="img/shop/single/gallery/07.jpg" alt="Product image">
                                    <div class="cz-image-zoom-pane"></div>
                                </div>
                                <div class="cz-preview-item" id="fourth"><img class="cz-image-zoom" src="{{ url('assets_public') }}/img/shop/single/gallery/08.jpg" data-zoom="img/shop/single/gallery/08.jpg" alt="Product image">
                                    <div class="cz-image-zoom-pane"></div>
                                </div>
                            </div>
                            <div class="cz-thumblist order-sm-1"><a class="cz-thumblist-item active" href="#first"><img src="{{ url('assets_public') }}/img/shop/single/gallery/th05.jpg" alt="Product thumb"></a><a class="cz-thumblist-item" href="#second"><img src="{{ url('assets_public') }}/img/shop/single/gallery/th06.jpg" alt="Product thumb"></a><a class="cz-thumblist-item" href="#third"><img src="{{ url('assets_public') }}/img/shop/single/gallery/th07.jpg" alt="Product thumb"></a><a class="cz-thumblist-item" href="#fourth"><img src="{{ url('assets_public') }}/img/shop/single/gallery/th08.jpg" alt="Product thumb"></a></div>
                        </div>
                    </div>
                    <!-- Product details-->
