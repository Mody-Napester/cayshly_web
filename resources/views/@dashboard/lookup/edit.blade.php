                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            ...
                            Edit Lookup "{{ getFromJson($resource->name , lang()) }}"
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('lookup.update', $resource->uuid) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Update lookup</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control @error('constraint_id') is-invalid @enderror" id="constraint_id" name="constraint_id">
                                            ...
                                            @foreach(\App\Enums\LookupConstraints::$constraints as $id => $constraints)
                                                <option @if($resource->constraint_id == $id) selected @endif value="{{ $id }}">{{ $constraints[lang()] }}</option>
                                            @endforeach
                                        </select>
