                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            ...
                            Points ({{ $resources->where('action', 1)->sum('amount') - $resources->where('action', 0)->sum('amount') }})
                        </h1>
                        <div class="page-header-subtitle">All Points Data</div>
                    </div>

                    <div class="col-12 col-xl-auto mt-4">
                        <a href="{{ route('user.points.control.get') }}?user={{ $user->id }}" class="btn btn-sm btn-white">
                            <i class="mr-2 text-primary" data-feather="plus"></i> <i class="mr-2 text-primary" data-feather="minus"></i> Control Points
                        </a>
                    </div>
                </div>
            </div>
